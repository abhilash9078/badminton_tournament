      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="bg-blue-50 rounded-xl p-6 shadow-sm">
            <h3 className="text-xl font-semibold text-blue-700 mb-4">Match Rules</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-500 mt-1"></div>
                <p className="ml-3 text-gray-700">All BWF rules will be applicable</p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-500 mt-1"></div>
                <p className="ml-3 text-gray-700">League matches: 21 points (golden point)</p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-500 mt-1"></div>
                <p className="ml-3 text-gray-700">Final: Best of 3 sets (21 points with deuce till 30)</p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-500 mt-1"></div>
                <p className="ml-3 text-gray-700">Official tournament shuttlecocks will be provided</p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-500 mt-1"></div>
                <p className="ml-3 text-gray-700">Match officials' decisions are final</p>
              </li>
            </ul>
          </div>
          
          <div className="bg-orange-50 rounded-xl p-6 shadow-sm">
            <h3 className="text-xl font-semibold text-orange-700 mb-4">Tournament Format</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-orange-500 mt-1"></div>
                <p className="ml-3 text-gray-700">Maximum 32 players (16 teams)</p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-orange-500 mt-1"></div>
              ...
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-orange-500 mt-1"></div>
                <p className="ml-3 text-gray-700">Knockout stage from quarter-finals</p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-orange-500 mt-1"></div>
                <p className="ml-3 text-gray-700">Partners selected via chit draw</p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-orange-500 mt-1"></div>
                <p className="ml-3 text-gray-700">Teams divided randomly into pools</p>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Tournament Structure</h3>
              ...
              <div className="min-w-[600px]">
                ...
                <div className="mt-8 flex justify-center items-center">
                  <div className="text-center">
                    <h4 className="font-semibold text-gray-800 mb-4">Knockout Stage</h4>
                    <img 
                    ...
                    />
                    <p className="text-sm text-gray-600">Top teams from each pool advance to quarter-finals</p>
                  </div>
                </div>
              </div>
            </div>
